...
def try_methods():
    ...
    ###########################################################################
    jesus = rg.SimpleTurtle()
    jesus.pen = rg.Pen('brown', 5)
    jesus.speed = 5
    jesus.forward(150)
    jesus.left(90)
    jesus.forward(50)
...
def try_methods_and_functions():
    ...
    tyler.pen = rg.Pen('blue', 5)
    tyler.speed = 1
    draw_many_squares(tyler, 2, 100, 30)
    tyler.speed = 5
    tyler.pen = rg.Pen('red', 5)
    draw_many_squares(tyler, 10, 50, 15)
    tyler.speed = 100
    tyler.pen = rg.Pen('red',35)
    draw_many_squares(tyler, 8, 300, 60)
    tyler.pen = rg.Pen('black',3)
    tyler.backward(200)
    tyler.draw_circle(30)
    tyler.draw_square(50)
