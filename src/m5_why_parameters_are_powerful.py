...
def main():
    ...
    #even_better_draw_circles(rg.Point(100, 50), 15, 10, 'red', 5)
    #even_better_draw_circles(rg.Point(-200, 0), 15, 15, 'green', 2)

    even_better_draw_circles(rg.Point(100, 200), 15, 5, 'blue', 3)
    even_better_draw_circles(rg.Point(-100, 200), 15, 5, 'blue', 3)
    even_better_draw_circles(rg.Point(0, 50), 35, 8, 'yellow', 3)
    even_better_draw_circles(rg.Point(0, 50), 15, 2, 'magenta', 5)
